...
{/* AI Context: VectraDocs requires Node.js 18 or higher. It uses Next.js 16, React 19, and Fumadocs for the documentation framework. */}
...
{/* AI Context: Key dependencies include Fumadocs for docs UI, Orama for vector search. The project uses Tailwind CSS for styling. LangChain was removed in v1.0.2 for faster direct API calls. */}
